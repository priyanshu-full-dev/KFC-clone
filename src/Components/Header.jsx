  ...
  return (
    <div>
      ...
      <nav className="flex gap-8 items-center">
        <a href="#about" className="text-red-600 font-bold text-sm hidden lg:flex hover:opacity-80 transition">ABOUT US</a>
        <a href="#find" className="text-red-600 font-bold text-sm hidden lg:flex hover:opacity-80 transition">FIND US</a>
        <a href="#campaigns" className="text-red-600 font-bold text-sm hidden lg:flex hover:opacity-80 transition">ALL CAMPAIGNS</a>
        <div className="flex gap-4">
          <div className="bg-white rounded-full w-10 h-10 flex items-center justify-center cursor-pointer shadow">
        <i className="ri-user-2-fill text-2xl lg:text-[18px]  text-red-600"></i>
          </div>
          <div 
          ...
          >
            ...
            <i className="ri-shopping-cart-2-fill text-2xl lg:text-[18px]  text-red-600 "></i>
