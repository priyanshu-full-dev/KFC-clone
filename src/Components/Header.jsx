  ...
  return (
    <div>
      ...
      <nav className="flex gap-8 items-center">
        ...
        <a href="#find" className="text-red-600 font-bold text-sm hidden md:flex hover:opacity-80 transition">FIND US</a>
        <a href="#campaigns" className="text-red-600 font-bold text-sm hidden md:flex hover:opacity-80 transition">ALL CAMPAIGNS</a>
